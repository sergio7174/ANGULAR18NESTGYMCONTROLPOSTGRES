...
getPackData(email:any): void {
  ...
  this.memberService.getmemberByEmail(email).pipe(
    takeUntilDestroyed(this.destroyRef)).subscribe((data:any) => {
     ...
     //alert("Estoy en status component - line 104 - data.member.namemember: "+data.data.member.email);
     alert("Estoy en status component - line 106 - data.member.email: "+data.member.email);
     ...
     /*alert("Estoy en classdetails component - line 61 - data.classname: "+data.clase.classname);  alert("Estoy en classdetails component - line 60 - data.clase.image: "+data.clase.image); */      
        ...
        alert("Estoy en status component - line 112 - data.member.image: "+ data.member.image)
  ...
  this.imageBackend = data.member.image;

  this.Finish_day= new Date(data.member.finishAt).getTime();
