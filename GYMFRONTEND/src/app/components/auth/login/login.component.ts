...
this.authService.login(this.form.value).pipe(
  takeUntilDestroyed(this.destroyRef)).subscribe({
    ...
    // Manejo de respuesta exitosa
      ...
      alert ("EStoy en login() - login component - line 124: - this.dataUser. :" + this.mensajeBackend);
      alert ("EStoy en login() - login component - line 125: - this.image :" + this.image);*/
      alert ("EStoy en login() - login component - line 126: - this.dataUser.user.isAdmin :" + this.dataUser.user.isAdmin);
      alert ("EStoy en login() - login component - line 127: - this.dataUser.token :" + this.dataUser.token);
