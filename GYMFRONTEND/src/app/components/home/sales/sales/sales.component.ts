...
getPackData(id:any): void {
  ...
  this.packService.getpackById(id).pipe(
    takeUntilDestroyed(this.destroyRef)).subscribe((data:any) => {
     ...
     alert("Estoy en classdetails component - line 61 - data.classname: "+data.clase.classname);  */      
     //alert("Estoy en classdetails component - line 115 - data.pack.imageUser: "+data.pack.imageUser); 
