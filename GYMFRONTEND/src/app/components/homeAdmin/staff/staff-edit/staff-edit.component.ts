...
getStaffData(id:any): void {
    ...
    this.staffService.getstaffById(id).pipe(
      takeUntilDestroyed(this.destroyRef)).subscribe((data:any) => {
       ...
       alert("Estoy en staff-edit.component - line 131 - data.name: "+data.staff.name);
       alert("Estoy en staff-edit.component - line 132 - data.email: "+data.staff.email);
       
      this.OldImage = data.staff.image;
    ...
    age:     data.staff.age,
    field:   data.staff.field,
    id_card: data.staff.id_card,
      ...
      /*** service to erase old image  ****************************************/
       ...
       this.staffService.deleteImage(this.OldImage).pipe(takeUntilDestroyed(this.destroyRef)).subscribe({
        next: (response) => {
          ...
          alert ("Estoy en EditStaff - line - 177 - message from backend: " + messageFromBackend );
        }
